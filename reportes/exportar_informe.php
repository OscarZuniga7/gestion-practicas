...
$sql = "SELECT 
            ...
            empresa,
            practica,
            hito,  -- ← NUEVO, va justo después de 'practica'
        ...
        FROM vw_informe_supervision_ultimo
...
if ($formato === 'csv') {
    ...
    header('Content-Disposition: attachment; filename=informe_supervision_202420.csv');
...
if ($formato === 'xls') {
    ...
    header("Content-Disposition: attachment; filename=informe_supervision_202420.xls");
...
<head>
<meta charset="utf-8">
<title>Informe Consolidado de Supervisión</title>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css">
</head>
<body class="p-4">
<div class="container">
  <h1 class="mb-3">Informe Consolidado de Supervisión</h1>
  ...
  <form class="row g-3 mb-4" method="get">
    ...
    <div class="col-md-3 d-flex align-items-end gap-2">
      ...
      <a class="btn btn-success" href="?ini=<?=$ini?>&fin=<?=$fin?>&practica=<?=urlencode($practica)?>&formato=xls">Descargar XLS</a>
      <a class="btn btn-outline-secondary" href="?ini=<?=$ini?>&fin=<?=$fin?>&practica=<?=urlencode($practica)?>&formato=csv">CSV</a>
    </div>
  </form>
