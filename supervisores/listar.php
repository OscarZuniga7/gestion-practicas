...
<html>
<head>
    <title>Supervisores Externos</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
</head>
<body class="container mt-5">

<h2 class="mb-4">Lista de Supervisores Externos</h2>
...
<table class="table table-bordered table-striped table-hover">
    ...
    <tbody>
        <?php
        // Obtener supervisores con nombre de la empresa asociada
        ...
        <tr>
            ...
            <td><?= $row['email'] ?></td>
            <td><?= $row['telefono'] ?></td>
            <td><?= $row['empresa_nombre'] ?? 'Sin empresa' ?></td>
            <td>
